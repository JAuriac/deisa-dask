# Detects scheduler network and routing limits (scheduler handles data path)
...
def main():
    ...
    os.makedirs("resExceptionVariantB", exist_ok=True)

    out_path = (
        f"resExceptionVariantB/scatter_times_"
