# Detects scheduler metadata throughput limits under sustained pressure
...
def main():
    ...
    os.makedirs("resExceptionVariantA", exist_ok=True)

    out_path = (
        f"resExceptionVariantA/scatter_times_"
