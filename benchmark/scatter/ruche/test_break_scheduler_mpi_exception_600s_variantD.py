# Detects pure scheduler RPC throughput limits (no payload transfer)
...
def main():
    ...
    while time.time() < stop_time:
        try:
            ...
            future = client.scatter(None, direct=True)
    ...
    os.makedirs("resExceptionVariantD", exist_ok=True)

    out_path = (
        f"resExceptionVariantD/scatter_times_"
